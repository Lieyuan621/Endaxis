...
export const commonBuffDefinitions = Object.freeze({
    ...
    abilityEventResponses: [
      {
        ...
        sequence: sequence(
          ...
          step('recoverDashEnergy', {
            amount: { kind: 'constant', value: 0.5 },
      ...
      {
        event: 'beforeHitByProjectile',
        priority: 0,
        sequence: sequence(
          branch(
            { kind: 'eventProjectilePerfectDodgeCooldownEquals', value: false },
            sequence(
              branch(
                {
  ...
  buff_common_dash_succeed_immune: {
    stackingType: 'unlimited',
    priority: 0,
    maxStackCount: 0,
    durationSeconds: 0.33,
