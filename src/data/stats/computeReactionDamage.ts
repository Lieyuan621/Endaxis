 ...
 *  applied. `durationBonus` is flat seconds (additive); `effectivenessBonus` adds to debuff
 *  potency only (e.g. corrosion max shred) — it does not multiply reaction damage. Only entries
 *  whose `reactionType` matches count. */
