...
const definition = {
  ...
  traits: [
    ...
    },
    {
      ...
      blackboard: {
        ...
        dmg_up2: [0.04, 0.048, 0.056, 0.064, 0.072, 0.08, 0.088, 0.096, 0.112],
  ...
  buffDefinitions: {
    buff_wpn_lance_0007_dmgup: {
      ...
      applyTags: [],
      extendTags: [],
      blackboard: { dmg_up: 0.1, duration: 0 },
      attributeModifiers: [
        {
    ...
    buff_wpn_lance_0007_dmgup2: {
      ...
      applyTags: [],
      extendTags: [],
      blackboard: { dmg_up2: 0.1, duration2: 0 },
      attributeModifiers: [
        {
          attribute: 'physicalDamageIncrease',
          slot: 'baseAddition',
          value: { blackboardKey: 'dmg_up2' },
        },
        {
          attribute: 'heatDamageIncrease',
          slot: 'baseAddition',
