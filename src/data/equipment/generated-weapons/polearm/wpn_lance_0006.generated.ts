  ...
  traits: [
    ...
    },
    {
            ...
            readBuffStackCount_5: {
              action: {
                ...
                parameters: {
                  target: 'caster',
                  outputKey: 'count',
                  query: { kind: 'id', buffIds: ['buff_wpn_lance_0006_exist'] },
                },
              },
      ...
      blackboard: {
        ...
        pulse_dmg_up: [0.1, 0.12, 0.14, 0.16, 0.18, 0.2, 0.22, 0.24, 0.28],
      },
    },
  ],
          ...
          nodes: {
            finishBuffsById_1: {
              action: {
                ...
                parameters: {
                  target: 'buffOwner',
                  buffIds: ['buff_wpn_lance_0006_exist'],
                  reason: 'other',
                },
              },
              next: null,
