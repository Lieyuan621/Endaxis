...
const definition = {
          ...
          nodes: {
            ...
            finishBuffsById_4: {
              action: {
                ...
                parameters: {
                  target: 'caster',
                  buffIds: ['buff_wpn_funnel_0016_wisd'],
                  reason: 'other',
                },
              },
              next: 'applyBuff_3',
            ...
            finishBuffsById_2: {
              action: {
                ...
                parameters: {
                  target: 'caster',
                  buffIds: ['buff_wpn_funnel_0016_will'],
                  reason: 'other',
                },
              },
              next: 'applyBuff_1',
  ...
  buffDefinitions: {
    ...
    buff_wpn_funnel_0016_will_atk: {
      ...
      priority: { blackboardKey: 'spell_dmg_taken_up' },
      maxStackCount: 0,
      durationSeconds: { blackboardKey: 'duration3' },
      triggerIntervalSeconds: 0,
      waitFirstTriggerInterval: true,
      maxTriggerCount: 1,
      presentation: {
      ...
      applyTags: [],
      extendTags: [],
      blackboard: { duration_dynamic: 0, duration3: 0, spell_dmg_taken_up: 0 },
      attributeModifiers: [],
      damageModifiers: [
        {
          ...
          processors: [
            {
              ...
              side: 'defender',
              zone: 'normal',
              addition: { blackboardKey: 'spell_dmg_taken_up' },
            },
          ],
        },
      ],
    ...
    buff_wpn_funnel_0016_will_dmg: {
      stackingType: 'highPriority',
      priority: { blackboardKey: 'spell_dmg_taken_up2' },
      maxStackCount: 0,
      durationSeconds: { blackboardKey: 'duration4' },
      triggerIntervalSeconds: 0,
      waitFirstTriggerInterval: true,
      maxTriggerCount: 1,
      presentation: {
      ...
      applyTags: [],
      extendTags: [],
      blackboard: { duration_dynamic: 0, duration4: 0, spell_dmg_taken_up2: 0 },
      attributeModifiers: [],
      damageModifiers: [
        {
          enabledSide: 'defender',
          ...
          processors: [
            {
              ...
              side: 'defender',
              zone: 'normal',
              addition: { blackboardKey: 'spell_dmg_taken_up2' },
            },
          ],
        },
      ],
    ...
    buff_wpn_funnel_0016_will_icon: {
      ...
      applyTags: [],
      extendTags: [],
      blackboard: { duration: 0, duration_dynamic: 0 },
      attributeModifiers: [],
      lifecycleSequences: { start: { $sequence: 'setCurrentBuffRemainingDuration_1' } },
      actionGraph: {
        main: {
          nodes: {
    ...
    buff_wpn_funnel_0016_wisd_atkup: {
      ...
      applyTags: [],
      extendTags: [],
      blackboard: { atk_up2: 0, duration2: 0 },
      attributeModifiers: [
        { attribute: 'Atk', slot: 'baseMultiplier', value: { blackboardKey: 'atk_up2' } },
      ],
      actionGraph: { main: { nodes: {} }, macros: {} },
    },
    buff_wpn_funnel_0016_wisd_natureup: {
      ...
      applyTags: [],
      extendTags: [],
      blackboard: { duration: 0, spell_dmg_up: 0 },
      attributeModifiers: [
        {
