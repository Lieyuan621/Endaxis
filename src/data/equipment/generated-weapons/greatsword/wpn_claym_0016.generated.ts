...
const definition = {
  ...
  traits: [
    ...
    },
    {
      ...
      blackboard: {
        ...
        phy_dmg_up2: [0.055, 0.066, 0.077, 0.088, 0.099, 0.11, 0.121, 0.132, 0.154],
      },
    },
  ],
  ...
  buffDefinitions: {
    buff_wpn_claym_0016_dmgup: {
      ...
      triggerIntervalSeconds: { blackboardKey: 'duration' },
      ...
      applyTags: [],
      extendTags: [],
      blackboard: { duration: 10, max_stack: 0, phy_dmg_up: 0 },
      attributeModifiers: [
        {
