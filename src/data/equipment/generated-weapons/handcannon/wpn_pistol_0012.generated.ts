...
const definition = {
            ...
            calculateActionValue_2: {
              action: {
                ...
                parameters: {
                  key: 'nature_dmg_up',
                  operation: 'multiply',
                  left: { kind: 'blackboard', key: 'nature_dmg_up_mult' },
  ...
  buffDefinitions: {
    buff_wpn_pistol_0012_natural: {
      ...
      priority: { blackboardKey: 'nature_dmg_up_mult' },
      maxStackCount: 1,
      ...
      applyTags: [],
      extendTags: [],
      blackboard: { duration: 0, nature_dmg_up_mult: 0 },
      attributeModifiers: [
        {
          attribute: 'natureDamageIncrease',
          slot: 'baseAddition',
          value: { blackboardKey: 'nature_dmg_up_mult' },
        },
      ],
      actionGraph: { main: { nodes: {} }, macros: {} },
    },
