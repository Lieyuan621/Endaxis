...
export const GAMEPLAY_TAG_PREDEFINE: GameplayTagPredefineDocument = {
  ...
  tags: {
    ...
    TyphoeaArchery: 'GameplayState/Interacting/TyphoeaArchery',
    ...
    InTyphoeaArcheryLevel: 'GameplayState/InTyphoeaArcheryLevel',
    IgnoreEnemyCollision: 'Status/IgnoreEnemyCollision',
    CanAIForceDontTeleport: 'AI/Status/CanAIForceDontTeleport',
  },
  queries: {
    InPull: {
      queryType: 'hasAny',
      tags: ['Status/Immobilized/Pull', 'Status/Unmovable/Pull'],
    },
    CantSwitchToCenter: {
      queryType: 'hasAny',
      tags: [
    ...
    IsUnMarkable: {
      queryType: 'hasAny',
      tags: ['SelectCategory/Unmarkable', 'GameplayState/TravelPole'],
    },
    IsDamageImmuneByLevel: {
      queryType: 'hasAny',
      tags: ['Immune/Damage', 'GameplayState/TravelPole'],
    },
    InForbiddenUsingItem: {
      queryType: 'hasAny',
      tags: ['Status/ForbiddenUsingItem', 'Category/Interactive/Mud', 'Status/InMud'],
    },
    InDisableFaceToAttacker: {
      queryType: 'hasAny',
      tags: ['Status/DisableFaceToAttacker'],
    },
    InDisableDash: {
      queryType: 'hasAny',
      tags: [
    ...
    CantPlayEnemyHurtAnim: {
      queryType: 'hasAny',
      tags: ['Status/Immobilized/Frozen', 'Status/Immobilized/OriginumFrozen'],
    },
    ...
    DisableInteract: {
      ...
      tags: [
        ...
        'GameplayState/Interacting/TyphoeaArchery',
    ...
    DisableCollide: {
      queryType: 'hasAny',
      tags: ['Status/Dead', 'GlobalState/Squad/Aced'],
    },
    DisableScan: {
      queryType: 'hasAny',
      tags: [
    ...
    IsHoldingBomb: {
      queryType: 'hasAny',
      tags: ['GameplayState/Interacting/Bomb'],
    },
    DisableNormalSkill: {
      queryType: 'hasAny',
      tags: [
    ...
    DisableTeleport: {
      queryType: 'hasAny',
      tags: ['GlobalState/Performance/Level', 'GlobalState/Gameplay/OnMovingPlatform'],
    },
    MuteEntityAudio: {
      queryType: 'hasAny',
      tags: ['Status/EntityRenderInvisible'],
    },
    DisableUseCampfire: {
      queryType: 'hasAny',
      tags: [
    ...
    ForcePlayRadio: {
      queryType: 'hasAny',
      tags: ['GlobalState/Performance/ForcePlayRadio'],
    },
    DisableWaterDrone: {
      queryType: 'hasAny',
      tags: ['GameplayState/Interacting/WaterDrone', 'GlobalState/SquadInFight'],
    },
    ...
    ForceNotInWater: {
      queryType: 'hasAny',
      tags: ['GameplayState/TravelPole', 'Status/ForceNotInWater'],
    },
    ...
    DisableInteractiveHintPerform: {
      queryType: 'hasAny',
      tags: ['GlobalState/SquadInFight', 'GlobalState/Performance/Level'],
    },
    ...
    BlightMiasmaUndeadable: {
      queryType: 'hasAny',
      tags: ['GameplayState/TravelPole', 'GlobalState/Performance/TravelPole'],
    },
    ForceStationaryPerform: {
      queryType: 'hasAny',
      tags: ['3C/PostmodelChanged'],
    },
    ...
    IsUnMarkableAnti: {
      queryType: 'hasAny',
      tags: ['SelectCategory/UnmarkableAnti'],
    },
    IsUnMarkableAlly: {
      queryType: 'hasAny',
      tags: ['SelectCategory/UnmarkableAlly'],
    },
    InterruptHenshin: {
      queryType: 'hasAny',
      tags: [
    ...
    DisableTeammateAIInteraction: {
      queryType: 'hasAny',
      tags: ['Status/DisableTeammateAIInteraction', '3C/PostmodelChanged'],
    },
    CanAIBarkPlayerIdle: {
      queryType: 'hasAny',
      tags: ['GlobalState/Performance/TravelPole'],
    },
    ForceAIStopFollow: {
      queryType: 'hasAny',
      tags: ['GlobalState/Gameplay/InStopTeammateFollowZone'],
    },
    CanPlayerBeDetected: {
      queryType: 'hasAny',
      tags: ['GameplayState/NearbyBlightMiasmaSafeZone'],
    },
    DontInterruptSkillBySwitchIn: {
      queryType: 'hasAny',
      tags: ['Status/DontInterruptSkillBySwitchIn'],
    },
    CantPushBySquad: {
      queryType: 'hasAny',
      tags: ['Status/InCommonInteraction', 'GameplayState/SnapshotMode/SnapshotPlayCharAction'],
    },
    DisablePivot: {
      queryType: 'hasAny',
      tags: [
    ...
    InMediumOrHigherWater: {
      queryType: 'hasAny',
      tags: ['Status/InWater/Medium', 'Status/InWater/DeepOrHigher'],
    },
    NotInTyphoeaArcheryLevel: {
      queryType: 'exceptAny',
      tags: ['GameplayState/InTyphoeaArcheryLevel'],
    },
    InTyphoeaArcheryLevel: {
      queryType: 'hasAny',
      tags: ['GameplayState/InTyphoeaArcheryLevel'],
    },
    DisableUltimateSkill: {
      queryType: 'hasAny',
      tags: ['Status/DisableUltimateSkill'],
    },
    IgnoreEnemyCollision: {
      queryType: 'hasAny',
      tags: ['Status/IgnoreEnemyCollision'],
    },
    DisableTyphoeaArchery: {
      queryType: 'hasAny',
      tags: [
        'Status/Dead',
        'Status/InCommonInteraction',
  ...
  immunityQueries: [
    {
      ...
      query: {
        queryType: 'hasAny',
        tags: ['Skill/Character/chr_0031_mifu/normalskill_3'],
      },
    },
    {
      ...
      query: {
        queryType: 'hasAny',
        tags: ['Immune/ImmuneNoGuard'],
      },
    },
    {
      tag: 'Skill/Character/Common/NormalSkillfx',
      query: {
        queryType: 'hasAny',
        tags: ['Skill/Character/chr_0038_purrche/ImmuneNormalSkillfx'],
      },
    },
    {
      ...
      query: {
        queryType: 'hasAny',
        tags: ['Immune/ImmunePhysicalStatus', 'Immune/ImmunePhysicalStatus/Airborne'],
      },
    },
    {
      ...
      query: {
        queryType: 'hasAny',
        tags: ['Immune/ImmunePhysicalStatus', 'Immune/ImmunePhysicalStatus/Crush'],
      },
    },
    {
      ...
      query: {
        queryType: 'hasAny',
        tags: ['Immune/ImmunePhysicalStatus', 'Immune/ImmunePhysicalStatus/Fracture'],
      },
    },
    {
      ...
      query: {
        queryType: 'hasAny',
        tags: ['Immune/ImmunePhysicalStatus', 'Immune/ImmunePhysicalStatus/KnockDown'],
      },
    },
    {
      ...
      query: {
        queryType: 'hasAny',
        tags: ['Immune/ImmuneSpellBurst', 'Immune/ImmuneSpellBurst/CrystBurst'],
      },
    },
    {
      ...
      query: {
        queryType: 'hasAny',
        tags: ['Immune/ImmuneSpellBurst', 'Immune/ImmuneSpellBurst/FireBurst'],
      },
    },
    {
      ...
      query: {
        queryType: 'hasAny',
        tags: ['Immune/ImmuneSpellBurst', 'Immune/ImmuneSpellBurst/NaturalBurst'],
      },
    },
    {
      ...
      query: {
        queryType: 'hasAny',
        tags: ['Immune/ImmuneSpellBurst', 'Immune/ImmuneSpellBurst/PulseBurst'],
      },
    },
    {
      ...
      query: {
        queryType: 'hasAny',
        tags: ['Immune/ImmuneSpellInflict', 'Immune/ImmuneSpellInflict/ImmuneCrystInflict'],
      },
    },
    {
      ...
      query: {
        queryType: 'hasAny',
        tags: ['Immune/ImmuneSpellInflict', 'Immune/ImmuneSpellInflict/ImmuneFireInflict'],
      },
    },
    {
      ...
      query: {
        queryType: 'hasAny',
        tags: ['Immune/ImmuneSpellInflict', 'Immune/ImmuneSpellInflict/ImmuneNaturalInflict'],
      },
    },
    {
      ...
      query: {
        queryType: 'hasAny',
        tags: ['Immune/ImmuneSpellInflict', 'Immune/ImmuneSpellInflict/ImmunePulseInflict'],
      },
    },
    {
      ...
      query: {
        queryType: 'hasAny',
        tags: ['Immune/ImmuneSpellStatus', 'Immune/ImmuneSpellStatus/ImmuneBurningStatus'],
      },
    },
    {
      ...
      query: {
        queryType: 'hasAny',
        tags: ['Immune/ImmuneSpellStatus', 'Immune/ImmuneSpellStatus/ImmuneConductStatus'],
      },
    },
    {
      ...
      query: {
        queryType: 'hasAny',
        tags: ['Immune/ImmuneSpellStatus', 'Immune/ImmuneSpellStatus/ImmuneCorruptStatus'],
      },
    },
    {
      ...
      query: {
        queryType: 'hasAny',
        tags: ['Immune/ImmuneSpellStatus', 'Immune/ImmuneSpellStatus/ImmuneFrozenStatus'],
      },
    },
    {
    ...
    },
    {
      ...
      query: {
        queryType: 'hasAny',
        tags: ['Immune/Airborne', 'Immune/SuperArmor'],
      },
    },
    {
      ...
      query: {
        queryType: 'hasAny',
        tags: ['Immune/SuperArmor', 'Immune/EnemyAngryArmor'],
      },
    },
    {
      ...
      query: {
        queryType: 'hasAny',
        tags: ['Immune/SuperArmor', 'Immune/BlowOff'],
      },
    },
    {
    ...
    },
    {
      ...
      query: {
        queryType: 'hasAny',
        tags: ['Immune/KnockDown', 'Immune/SuperArmor'],
      },
    },
    {
    ...
    },
    {
      ...
      query: {
        queryType: 'hasAny',
        tags: ['Immune/Stunned', 'Immune/SuperArmor'],
      },
    },
    {
      ...
      query: {
        queryType: 'hasAny',
        tags: ['Immune/SpeedDownSettlement'],
      },
    },
    {
