...
export function getDefaultContingencyContractSeason(): ContingencyContractSeason | null {
  return (
    getContingencyContractSeason(contingencyContractDatabase.defaultSeasonId) ??
...
export function getContingencyContractTags(
  season: ContingencyContractSeason,
): ContingencyContractTag[] {
  return season.groups.flatMap(group => group.tags);
}

export function getContingencyContractTagMap(
  season: ContingencyContractSeason,
): Map<number, ContingencyContractTag> {
