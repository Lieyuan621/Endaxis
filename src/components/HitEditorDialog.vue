...
<template>
  ...
  >
        ...
        <div class="field-grid field-grid--select-row">
          ...
          <label class="field">
            ...
            <EaSelect
              ...
              popper-class="hit-editor-select-popper"
            >
              <EaOption value="" :label="t('common.none')" />
              <EaOption
          ...
          <label class="field">
            ...
            <EaSelect
              ...
              popper-class="hit-editor-select-popper"
            >
              <EaOption value="recover" :label="t('propertiesPanel.damage.spKindRecover')" />
              <EaOption value="refund" :label="t('propertiesPanel.damage.spKindRefund')" />
            </EaSelect>
          </label>
        </div>
      </section>
        ...
        <div v-if="selectedEffect" class="effect-detail">
            ...
            <div class="field-grid field-grid--effect-select-row">
              ...
              <label v-if="showDisplayTypeField" class="field full">
                ...
                <EaSelect
                  ...
                  popper-class="hit-editor-select-popper"
                >
                  <EaOption value="default" :label="t('common.default')" />
                  <EaOptionGroup
            ...
            <div v-if="advancedSettingsOpen" class="advanced-settings-body">
              <div class="field-grid field-grid--effect-select-row">
                <label v-if="canEditStackStrategy" class="field">
                  ...
                  <EaSelect
                    ...
                    popper-class="hit-editor-select-popper"
                  >
                    <EaOption value="" :label="t('common.default')" />
                    <EaOption
              ...
              <div class="field-grid field-grid--effect-text-row">
                <label class="field">
                  <span>ID</span>
                  <EaInput
                    :model-value="displayTextValue(selectedEffect.id)"
                    size="sm"
                    @input="value => patchSelectedEffect('id', optionalString(value))"
                  />
                </label>
                <label class="field">
                  <span>{{ t('common.name') }}</span>
                  <EaInput
                    :model-value="displayTextValue(selectedEffect.name)"
                    size="sm"
                    @input="value => patchSelectedEffect('name', optionalString(value))"
                  />
                </label>
                <label class="field">
                  <span>{{ t('hitEditor.icdGroup') }}</span>
                  <EaInput
                    :model-value="selectedEffect.icdGroup || ''"
                    size="sm"
                    @input="value => patchSelectedEffect('icdGroup', optionalString(value))"
                  />
                </label>
              </div>
              ...
              <div class="field-grid field-grid--effect-check-row">
                <EaCheckbox
                  :model-value="selectedEffect.stacks === 'fromConsume'"
                  class="check-field"
                  @update:model-value="patchSelectedEffectStacksFromConsume"
                >
                  {{ fieldLabel('stacksFromConsume') }}
                </EaCheckbox>
                <EaCheckbox
                  :model-value="!!selectedEffect.hide"
                  class="check-field"
                  @update:model-value="value => patchSelectedEffectBool('hide', value)"
                >
                  {{ t('hitEditor.hide') }}
                </EaCheckbox>
                <EaCheckbox
                  :model-value="!!selectedEffect.ignoreTimeShift"
                  class="check-field"
                  @update:model-value="value => patchSelectedEffectBool('ignoreTimeShift', value)"
                >
                  {{ t('hitEditor.ignoreTimeShift') }}
                </EaCheckbox>
              </div>
          ...
          <div class="kind-field-groups">
            ...
            <template v-if="selectedEffect.kind === 'status'">
              ...
              <div class="field-grid field-grid--effect-check-row">
                <EaCheckbox
                  :model-value="!!selectedEffect.silent"
                  class="check-field"
                  @update:model-value="value => patchSelectedEffectBool('silent', value)"
                >
                  {{ fieldLabel('silent') }}
                </EaCheckbox>
                <EaCheckbox
                  :model-value="!!selectedEffect.external"
                  class="check-field"
                  @update:model-value="value => patchSelectedEffectBool('external', value)"
                >
                  {{ fieldLabel('external') }}
                </EaCheckbox>
              </div>
            ...
            <template v-if="selectedEffect.kind === 'physicalStatus'">
              ...
              <div class="field-grid field-grid--effect-check-row">
                <EaCheckbox
                  :model-value="!!selectedEffect.forced"
                  class="check-field"
                  @update:model-value="value => patchSelectedEffectBool('forced', value)"
                >
                  {{ fieldLabel('forced') }}
                </EaCheckbox>
              </div>
            ...
            >
              <div class="field-grid field-grid--effect-select-row">
                ...
                <label v-if="selectedEffect.kind === 'damageOverTime'" class="field">
                  ...
                  >
                    <EaOption value="" :label="t('common.default')" />
                    <EaOption value="each" :label="multiplierModeLabel('each')" />
                    <EaOption value="split" :label="multiplierModeLabel('split')" />
                  </EaSelect>
                </label>
              </div>
              <div class="field-grid field-grid--effect-input-row">
              ...
              <div class="field-grid field-grid--effect-check-row">
                <EaCheckbox
                  ...
                  :model-value="!!selectedEffect.scaleByCrit"
                  class="check-field"
                  @update:model-value="value => patchSelectedEffectBool('scaleByCrit', value)"
                >
                  {{ fieldLabel('scaleByCrit') }}
                </EaCheckbox>
                <EaCheckbox
                  v-if="selectedEffect.kind === 'damageOverTime'"
                  :model-value="!!selectedEffect.snapshot"
                  class="check-field"
                  @update:model-value="value => patchSelectedEffectBool('snapshot', value)"
                >
                  {{ fieldLabel('snapshot') }}
                </EaCheckbox>
                <EaCheckbox
                  v-if="selectedEffect.kind === 'damageOverTime'"
                  :model-value="selectedEffect.canCrit !== false"
                  class="check-field"
                  @update:model-value="value => patchSelectedEffectBool('canCrit', value)"
                >
                  {{ fieldLabel('canCrit') }}
                </EaCheckbox>
                <EaCheckbox
                  v-if="selectedEffect.kind === 'damageOverTime'"
                  :model-value="!!selectedEffect.skipFirstTick"
                  class="check-field"
                  @update:model-value="value => patchSelectedEffectBool('skipFirstTick', value)"
                >
                  {{ fieldLabel('skipFirstTick') }}
                </EaCheckbox>
                <EaCheckbox
                  v-if="selectedEffect.kind === 'damageOverTime'"
                  :model-value="!!selectedEffect.cancelOnRefresh"
                  class="check-field"
                  @update:model-value="value => patchSelectedEffectBool('cancelOnRefresh', value)"
                >
                  {{ fieldLabel('cancelOnRefresh') }}
                </EaCheckbox>
              </div>
            </template>
            ...
            <template v-if="selectedEffect.kind === 'consume'">
              ...
              <div class="field-grid field-grid--effect-select-row">
                <label class="field">
                  ...
                  >
                    <EaOption value="" :label="t('common.default')" />
                    <EaOption value="team" :label="consumeScopeLabel('team')" />
                  </EaSelect>
                </label>
              </div>
              <div class="field-grid field-grid--effect-input-row">
    ...
    <template #footer>
      <EaDialogActions>
        <EaButton variant="danger" size="sm" type="button" @click="emit('delete')">
          {{ t('hitEditor.deleteHit') }}
        </EaButton>
        <div class="spacer"></div>
        <EaButton size="sm" type="button" @click="open = false">
          {{ t('common.cancel') }}
        </EaButton>
        <EaButton size="sm" type="button" @click="save">
          {{ t('hitEditor.save') }}
        </EaButton>
      </EaDialogActions>
    </template>
...
:global(.hit-editor-dialog .ea-button) {
